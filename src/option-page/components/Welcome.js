...
export default function Welcome() {
  ...
  const appName = t("appName"); // Object Finder AI
  const getStarted = t("getStarted"); // Get Started for Free
  const appDescription = t("appDescription"); // Find object names in the picture using AI
  ...
  const subHeadOne = t("subHeadOne"); // Know names of the objects given in the Picture.
  const subHeadOneDesc = t("subHeadOneDesc"); // Select any picture on any webpage and find the names of objects in the Picture or uplaod your image on our website to edit images like a photographer.
  const subHeadTwo = t("subHeadTwo"); // Database of Million of object names.
  const subHeadTwoDesc = t("subHeadTwoDesc"); // Search from million of objects to find object names given in the picture.
  const labelGettingStarted = t("labelGettingStarted"); // Getting Started
  const labelEditPhotoLike = t("labelEditPhotoLike"); // How to Learn new Words like a Pro
  const headF1 = t("headF1"); // Go to Website.
  const headF2 = t("headF2"); // Find Picture.
  const headF3 = t("headF3"); // Get Object Name.
  const headF1Desc = t("headF1Desc"); // Open Any website where you have pictures of objects or things.
  const headF2Desc = t("headF2Desc"); // Select the picture from which you want to learn the object names.
  const headF3Desc = t("headF3Desc"); // Click on the extension icon and get object name.
              ...
              <ul className="list-reset lg:flex justify-end flex-1 items-center">
                ...
                <li className="mr-3">
                  <a
                    ...
                    href={constants.support.uninstallFeedbackForm}
                  >
                    {linkSupport}
                  </a>
                </li>
